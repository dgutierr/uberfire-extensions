...
public class ACLSettings implements IsWidget {
    ...
    public ACLSettings(View view,
        ...
        homePerspectiveDropDown.setMaxItems(20);
    ...
    private void open(Role role) {
        String homePerspectiveId = authzPolicy != null ? authzPolicy.getHomePerspective(role) : null;
        int priority = authzPolicy != null ? authzPolicy.getPriority(role) : 0;
        open(homePerspectiveId, priority);
    }

    private void open(Group group) {
        String homePerspectiveId = authzPolicy != null ? authzPolicy.getHomePerspective(group) : null;
        int priority = authzPolicy != null ? authzPolicy.getPriority(group) : 0;
        open(homePerspectiveId, priority);
    }
